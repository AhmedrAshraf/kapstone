-- Drop and recreate case_reports table with proper structure
...
CREATE TABLE case_reports (
  ...
  CONSTRAINT case_reports_author_id_fkey FOREIGN KEY (author_id) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE TABLE case_report_replies (
  ...
  created_at timestamptz DEFAULT now(),
  updated_at timestamptz DEFAULT now(),
  CONSTRAINT case_report_replies_report_id_fkey FOREIGN KEY (report_id) REFERENCES case_reports(id) ON DELETE CASCADE,
  CONSTRAINT case_report_replies_author_id_fkey FOREIGN KEY (author_id) REFERENCES users(id) ON DELETE CASCADE,
  CONSTRAINT case_report_replies_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES case_report_replies(id) ON DELETE CASCADE
);
...
CREATE INDEX IF NOT EXISTS idx_case_reports_author_id ON case_reports(author_id);
CREATE INDEX IF NOT EXISTS idx_case_reports_created_at ON case_reports(created_at);
CREATE INDEX IF NOT EXISTS idx_case_report_replies_report_id ON case_report_replies(report_id);
CREATE INDEX IF NOT EXISTS idx_case_report_replies_author_id ON case_report_replies(author_id);
CREATE INDEX IF NOT EXISTS idx_case_report_replies_parent_id ON case_report_replies(parent_id);
